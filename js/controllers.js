...
// ===================================================================
  ...
  //Default Values
    ...
    consumerService.getDestinations($scope.urlbase, $scope.apiversion, $scope.sub_account_id, $scope.application_id, $scope.consumer_id, $scope.bucket_key).success(function(data) {
